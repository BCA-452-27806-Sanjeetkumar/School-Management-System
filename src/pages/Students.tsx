...
import { validateStudentForm, validateName, validateEmail, validateRollNumber, validatePhone, validateSelect } from '@/lib/validation';
...
export default function Students() {
  ...
  const { errors, setError, setErrors, clearErrors } = useFormValidation();
  ...
  const validateFieldRealTime = (field: string, value: string) => {
    ...
    switch (field) {
      ...
      case 'roll_number':
        ...
        break;
      case 'class_id':
        error = validateSelect(value, 'Class');
        break;
      case 'guardian_name':
        error = validateName(value, 'Guardian Name');
        break;
      case 'guardian_phone':
        error = validatePhone(value, 'Guardian Phone');
        break;
      default:
        break;
    }
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label htmlFor="class" className={errors.class_id ? 'text-destructive' : ''}>
                ...
                <Select
                  ...
                  onValueChange={(value) => {
                    ...
                    validateFieldRealTime('class_id', value);
                  }}
                >
            ...
            <FormInput
              ...
              onChange={(e) => {
                ...
                validateFieldRealTime('roll_number', e.target.value);
              }}
              placeholder="1001"
            ...
            <div className="grid grid-cols-2 gap-4">
              <FormInput
                ...
                onChange={(e) => {
                  ...
                  validateFieldRealTime('guardian_name', e.target.value);
                }}
              ...
              <FormInput
                ...
                onChange={(e) => {
                  ...
                  validateFieldRealTime('guardian_phone', e.target.value);
                }}
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label className={errors.class_id ? 'text-destructive' : ''}>
                  Class <span className="text-destructive">*</span>
                </Label>
                <Select
                  value={formData.class_id}
