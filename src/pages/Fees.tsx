...
import { validateFeeForm } from '@/lib/validation';
...
export default function Fees() {
  ...
  const handleAddFee = async () => {
    // Validate form
    const validation = validateFeeForm(
      formData.student_id,
      formData.amount,
      formData.due_date,
        ...
        <div className="rounded-2xl border bg-card p-6 card-hover">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">₹{(totalCollected * 83).toLocaleString()}</p>
            </div>
          </div>
        </div>
        <div className="rounded-2xl border bg-card p-6 card-hover">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold">₹{(totalPending * 83).toLocaleString()}</p>
            </div>
          </div>
        </div>
        <div className="rounded-2xl border bg-card p-6 card-hover">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData} barGap={8}>
              ...
              <Tooltip
                ...
                formatter={(value: number) => [`₹${(value * 83).toLocaleString()}`]}
              />
              ...
              return (
                ...
                >
                  ...
                  <TableCell className="font-semibold">
                    ₹{(Number(record.amount) * 83).toLocaleString()}
                  </TableCell>
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              <Label htmlFor="student" className={errors.student_id ? 'text-destructive' : ''}>
